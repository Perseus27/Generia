...
[h3|Round]Round[/h3]
A combat round comprises one [url:#Turn]turn[/url] for every combatant. Each combatant can take only one turn per round. Turn order within a combat round is determined by [url:/w/generia-perseus27/a/values-article#Initiative]Initiative[/url].
...
[ul]
[li]Movement (up to the acting creature’s maximum [url:/w/generia-perseus27/a/values-article#MS]Movement Speed[/url])[/li]
[li]A movement skill[/li]
[li]A spell with the tag [section:clr-movement]MOVEMENT[/section][/li]
[/ul]

[h3|Reactions]Reactions[/h3]
...
[h3|FreeActions]Free Actions / Reactions[/h3]
...
[h3|HiddenActions]Hidden Actions[/h3]
...
[h3|BasicAttack]Basic Attack[/h3]
...
[b]Procedure:[/b]
[ol]
[li]Attacker rolls [b][section:clr-roll]1d20[/section][/b] + [url:/w/generia-perseus27/a/values-article#AttackValue]Attack Value[/url][/li]
...
[b]See [url:/w/generia-perseus27/a/ranged-combat-article]Ranged Combat[/url] for details.[/b]
...
[b]Procedure:[/b]
[ol]
[li]Attacker rolls [b][section:clr-roll]1d20[/section][/b] + [url:/w/generia-perseus27/a/values-article#AttackValue]Attack Value[/url] (see [url:/w/generia-perseus27/a/ranged-combat-article]Ranged Combat[/url] for Advantage, etc.)[/li]
[li]Defender may [url:#Dodge]dodge[/url] the rolled value (see [url:/w/generia-perseus27/a/fernkampf-article]Ranged Combat[/url] for Advantage, etc.)[/li]
[/ol]
...
[br]Roll the block check ([url:/w/generia-perseus27/a/values-article#BlockValue][b]Block Value[/b][/url] + [b][section:clr-roll]1d12[/section][/b]) and compare it to the attacker’s roll.
[ul]
[li][b]Block roll ≥ attack roll:[/b]
[br]Block succeeds. Incoming damage is reduced by [url:/w/generia-perseus27/a/values-article#BlockStrength]Block Strength[/url].[/li]
[li][b]Block roll < attack roll:[/b]
...
[br]First, roll the parry check ([url:/w/generia-perseus27/a/values-article#ParryValue][b]Parry Value[/b][/url] + [b][section:clr-roll]1d12[/section][/b]) and compare it to the attacker’s roll.
[ul]
...
[li]Use [url:/w/generia-perseus27/a/skills-E28093-tier-i-article#Counter][i]Counter[/i][/url], if learned[/li]
[/ol]
*The attacker’s [url:/w/generia-perseus27/a/perks-E28093-combat-article][i]Opportunist[/i][/url] perk is not triggered, but nearby enemies’ may be.

[h3|Dodge]Dodge[/h3]
Characters can [i]dodge[/i] weapon attacks and projectiles. To succeed, match the attack roll with [b][section:clr-attr]AGI-MOD[/section] + [section:clr-attr]PER-MOD[/section] + [section:clr-roll]1d12[/section][/b]. On success, all damage is avoided; on failure, the character takes full damage.
...
[/ul]
For ranged weapon damage, please refer to [url:/w/generia-perseus27/a/ranged-combat-article]Ranged Combat[/url].

[h3|Hit]Hit[/h3]
An attack is a [i]hit[/i] if it overcomes the target’s [url:/w/generia-perseus27/a/values-article#AV]Armor Value (AV)[/url] or [url:/w/generia-perseus27/a/values-article#MD]Magic Defense (MD)[/url].
...
[br]Each attack counted as a backstab has [url:/w/generia-perseus27/a/core-mechanics-article#Advantage]Advantage 1[/url] on the attack roll.

[h3|MountedCombat]Mounted Combat[/h3]
Rider and mount always act simultaneously on the rider’s Initiative.
[h4]Attacks[/h4]
All [url:#BasicAttack]basic[/url] and [url:#RangedAttack]ranged[/url] attacks made from the back of a mount have [url:/w/generia-perseus27/a/core-mechanics-article#Disadvantage]Disadvantage 1[/url] if the mount moved this turn.
[h4]Defense[/h4]
Mounted [url:#Dodge]dodge[/url] checks have [url:/w/generia-perseus27/a/core-mechanics-article#Disadvantage]Disadvantage 1[/url] but are [url:/w/generia-perseus27/a/core-mechanics-article#Eased]eased[/url] by the value of the [url:/w/generia-perseus27/a/fertigkeiten-E28093-zivil-article]civil skill[/url] [i]Riding[/i]. Use the mount’s [section:clr-attr]AGI[/section].
...
[h3|Foci]Foci[/h3]
If not otherwise specified, all spellcasting traditions require specific items to channel magic. If a caster does not have access to their focus, they have [url:/w/generia-perseus27/a/core-mechanics-article#Disadvantage]Disadvantage 1[/url] on all magic-related rolls, and all targets have [url:/w/generia-perseus27/a/core-mechanics-article#Advantage]Advantage 1[/url] on all [section:clr-save]saves[/section] against their magic.

[h2|SpellTypes]Spell Types[/h2]
[h3|SA]Spell Attack ([section:clr-sa]SA[/section])[/h3]
A [i]spell attack[/i] sets the target value for a successful [url:/w/generia-perseus27/a/core-mechanics-article#Save]save[/url] against a spell’s effects. Its attack value is [section:clr-roll]1d20[/section] plus the attribute modifier listed in the syntax.
[h4]Syntax[/h4]
...
Projectile attacks are similar to most [url:#RangedAttack]ranged attacks[/url]. They can be [url:/w/generia-perseus27/a/definitions-article#Dodge]dodged[/url] like regular projectiles, [url:/w/generia-perseus27/a/definitions-article#Block]blocked[/url] with a shield, and sometimes parried if the character has the necessary perks. Their attack value is [section:clr-roll]1d20[/section] plus the attribute modifier listed in the syntax.
[h4]Syntax[/h4]
...
[i]See [url:/w/generia-perseus27/a/core-mechanics-article#DC]Determined Check[/url].[/i]
...
To move unseen, a creature makes an [b][section:clr-attr]AGI[/section] check[/b] against the opponent’s [b][section:clr-attr]PER[/section]-[section:clr-dc]DC[/section][/b] [i]([section:clr-attr]PER-MOD[/section] + 10)[/i].
[br]Apply:
[ul]
[li]Total cover: +2 Advantage[/li]
[li]Full cover: +1 Advantage[/li]
[li]Half cover: +0 Advantage[/li]
[li]No cover: −1 Advantage[/li]
[li]Open ground: −2 Advantage[/li]
[/ul]
...
A creature can attempt to jump to any spot using any action. First determine the [i]jump score[/i] ([b][section:clr-attr]STR-MOD[/section][/b] + [b][section:clr-attr]AGI-MOD[/section][/b] + [section:clr-roll]1d20[/section]).
[br]If the jump score exceeds [b](jump height * 4) + (jump distance * 2)[/b], the jump succeeds. If it is lower than [b]((jump height * 4) + (jump distance * 2)) * 2[/b], the creature becomes [url:/w/generia-perseus27/a/status-effects-article#AusDemGleichgewicht]off-balance[/url].
[h4]Example[/h4]
...
Falling creatures take [section:clr-roll]1d4[/section] [url:/w/generia-perseus27/a/damage-types-article#Absolute]absolute[/url] damage for every meter of fall distance. The total damage is increased by [section:clr-value]1[/section] for each point of [i]Total Weight[/i] above the [i]Carry Limit[/i].
[h4|FallCheck]Fall Check[/h4]
When a creature begins to fall, it may attempt a fall check ([section:clr-attr]AGI-MOD[/section] + [section:clr-value][i]Athletics[/i][/section]) against the highest of these values, if they are applicable:
[ul]
...
[/ul]
On success, the creature manages to stabilize itself during the fall and reduces the falling distance considered for the damage calculation by [section:clr-attr]AGI-MOD[/section].
[br][b]Example:[/b]
[br]Creature X has an [section:clr-attr]AGI-MOD[/section] of [section:clr-value]3[/section] and falls [section:clr-value]5 meters[/section]. If it fails the fall check, it takes [section:clr-roll]5d4[/section] absolute damage. If it succeeds, it only takes [section:clr-roll]2d4[/section] absolute damage.
...
[br]If the target fails to parry or dodge, it becomes [url:/w/generia-perseus27/a/status-effects-article#Grappled]grappled[/url].