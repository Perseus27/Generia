...
[br][b]...[/b]
[br]The freecast check is [url:/w/generia-perseus27/a/core-mechanics-article#Eased]eased[/url] by the caster's primary [url:#SpellcastingAttributes]spellcasting attribute[/url] as well as any appropriate proficiency values (e.g., [i]Arcane, Cacophony, Luna...[/i])
[h4]Failure[/h4]
...
[br]After executing all required rolls, the caster must make a [url:/w/generia-perseus27/a/chaotic-magic-article#ChaosCheck]Chaos Check[/url].

[h1|CastingTypes]Casting Types[/h1]
There are five primary Casting Types: [url:/w/generia-perseus27/a/definitions-article#SA]Spell Attacks[/url], [url:/w/generia-perseus27/a/definitions-article#PA]Projectile Attacks[/url], [url:/w/generia-perseus27/a/definitions-article#SD]Spell Defense[/url], [url:/w/generia-perseus27/a/definitions-article#DC]Determined Cast[/url], and [url:/w/generia-perseus27/a/definitions-article#Surecast]Surecast[/url].
...
[br][b]Use cases:[/b] Any spell that behaves like a [url:/w/generia-perseus27/a/definitions-article#RangedAttack]ranged attack[/url].
...
Some [section:clr-pa]Projectile Attacks[/section] and [section:clr-sd]Spell Defenses[/section] may require a secondary attribute to make them comparable to [url:/w/generia-perseus27/a/definitions-article#RangedAttack]ranged attacks[/url] and [url:/w/generia-perseus27/a/definitions-article#Block]basic defenses[/url].
[br]The caster may pick any attribute for this, as long as the choice is reasonably justifiable.
[br][i][b]GM Note:[/b] INT, WIL, PER, or AGI tend be good picks, depending on spell and character flavor.[/i]
...
[br][b][section:clr-attr]AGI[/section]:[/b] Physical, dodgeable
